#' Qualitative Colours
#'
#' Qualitative, colour blind safe colour palette developed by Okabe and Ito and
#' used by plots in the gordon01 package.
#'
