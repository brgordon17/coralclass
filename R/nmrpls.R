#' PLS-DA analysis of NMR data.
#'
#' \code{nmrpls()} was used to perform the partial least squares discriminant
#' analysis of the NMR data (\code{./data/nmrdata.rda})
#'
#' \code{nmrpls()} loads \code{nmrdata} and performs a PLS-DA of the data using
